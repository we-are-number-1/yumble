// THIS FILE IS FOR PURELY TESTING PURPOSES ONLY. PLEASE DELETE BEFORE PRESENTATION / PRODUCTION BUILDS

let photos = [];
let apiKey = "AIzaSyB3_9KbQ5Ali-VPfXjN9L2-kWXagOJj_lk"
...
for (let x in photoRefs) {
    photos.push(`https://maps.googleapis.com/maps/api/place/photo?photoreference=${photoRefs[x]}&key=${apiKey}&maxheight=600&maxwidth=600`);
}
